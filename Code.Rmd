---
title: "Technology-assisted instruction with teacher prompts on fraction multiplication word problems for students with learning disabilities: Visual analysis and Bayesian models"
date: "`r Sys.Date()`"
output:
  html_document:
     toc: true
