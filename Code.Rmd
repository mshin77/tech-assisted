...
This website contains data and R code used for the data processing and analysis in Shin and Park (in press). The scripts have been posted on an online data repository, accessible at the [Center for Open Science](https://doi.org/10.17605/OSF.IO/F9832).

Shin, M., & Park, J. (in press). Technology-assisted instruction with teacher prompts on fraction multiplication word problems: A single-case design with visual analysis and Bayesian multilevel modeling. *Assistive Technology*. https://mshin77.github.io/tech-assisted
...
#### **Odd Ratios and Credible Intervals**

```{r}
exp(fixef(Model)[,-2]) %>% round(3)
```
...
#### **Table S1. Rubric for Fraction Multiplication Word Problems**
